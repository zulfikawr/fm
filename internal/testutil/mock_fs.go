...
type MockFileSystem struct {
	...
	WalkFunc           func(ctx context.Context, root string, walkFn filepath.WalkFunc) error
...
func (m *MockFileSystem) Walk(ctx context.Context, root string, walkFn filepath.WalkFunc) error {
	if m.WalkFunc != nil {
