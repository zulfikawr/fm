...
func HandleUpdateMessages(m *context.Model, msg tea.Msg) tea.Cmd {
	switch msg := msg.(type) {
	...
	case UpdateFinishedMsg:
		...
		if msg.Err != nil {
			return SetErrMsg(m, "Update failed: "+msg.Err.Error())
		}
		m.UI.UpdateAvailable = false
		return SetMsg(m, "Successfully updated. Press [r] to restart")
