...
func DefaultKeybindings() []Keybinding {
	return []Keybinding{
		...
		{Action: "select_all", Keys: []string{"ctrl+a"}, Category: "selection"},
		{Action: "clear_selection", Keys: []string{"esc"}, Category: "selection"},

		// Tabs
		{Action: "new_tab", Keys: []string{"ctrl+t"}, Category: "tabs"},
		{Action: "close_tab", Keys: []string{"ctrl+w"}, Category: "tabs"},
		{Action: "switch_tab_1", Keys: []string{"1"}, Category: "tabs"},
		{Action: "switch_tab_2", Keys: []string{"2"}, Category: "tabs"},
		{Action: "switch_tab_3", Keys: []string{"3"}, Category: "tabs"},
		{Action: "switch_tab_4", Keys: []string{"4"}, Category: "tabs"},
		{Action: "switch_tab_5", Keys: []string{"5"}, Category: "tabs"},
		{Action: "switch_tab_6", Keys: []string{"6"}, Category: "tabs"},
		{Action: "switch_tab_7", Keys: []string{"7"}, Category: "tabs"},
		{Action: "switch_tab_8", Keys: []string{"8"}, Category: "tabs"},
		{Action: "switch_tab_9", Keys: []string{"9"}, Category: "tabs"},
		...
		{Action: "create", Keys: []string{"ctrl+n"}, Category: "file_ops"},
		...
		{Action: "fuzzy_search", Keys: []string{"ctrl+f"}, Category: "search"},
		{Action: "toggle_regex_search", Keys: []string{"ctrl+r"}, Category: "search"},
		...
		{Action: "analyze", Keys: []string{"ctrl+u"}, Category: "general"},
		{Action: "trash_view", Keys: []string{"t"}, Category: "general"},
		{Action: "clipboard_view", Keys: []string{"ctrl+b"}, Category: "general"},
		{Action: "logs_view", Keys: []string{"ctrl+l"}, Category: "general"},
